...
urlpatterns = [
    ...
    path("users/<str:username>/friends/<str:friend_tag>/delete",
         views.delete_friend),
    path("users/notifications", views.user_notification),
    path("notifications/<int:id>/delete", views.delete_notification),
]

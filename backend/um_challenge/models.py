...
class Um_Compete(models.Model):
    SUBJECT_CHOICES = (("Mathematics", "M"), ("History", "H"), ("Ethics", "E"), ("Science", "S"), ("Geography", "G"), ("Languages", "L"), ("Art", "A"), ("Communication/personal_help", "C"), ("Fun", "F"))
    um_compete_challenge_id = models.CharField(max_length=10, primary_key=True, default="aabbccddee")
    um_compete_challenge_subject = models.CharField(choices=SUBJECT_CHOICES, max_length=40, default="Fun")
    ...
    team_1_score = models.JSONField(default=[])
    team_2_score = models.JSONField(default=[])

...
class SentShrtTrmCh(models.Model):
    SUBJECT_CHOICES = (("Mathematics", "M"), ("History", "H"), ("Ethics", "E"),
                       ("Science", "S"), ("Geography", "G"), ("Languages",
                                                              "L"),
                       ("Art", "A"), ("Communication/personal_help", "C"))
    cover = models.JSONField(default={})
    challenge_id = models.CharField(blank=False,
                                    max_length=11,
                                    primary_key=True)  #ShTeCha999
    ...
    mastered = models.JSONField(default=list)
